...
function clearSelection(){s.selection=null;s.selectionDraft=null;$('#panelImage').hidden=false;$('#metadataList').hidden=false;$('#sourceLink').hidden=false;panel(null);render();}
