window.localeDictionary = {
  ...
  imagePanelEyebrow: 'IMAGE INFO PANEL', openSource: 'Open original image ↗', downloadAll: 'Download all', downloading: 'Downloading {current}/{total}…', downloadFailed: 'Image download unavailable ({count})',
